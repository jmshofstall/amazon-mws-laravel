...
use Jmshofstall\AmazonMws\AmazonFulfillmentOrderCreator;
use PHPUnit\Framework\TestCase;

/**
 * Generated by PHPUnit_SkeletonGenerator 1.2.0 on 2012-12-12 at 13:17:14.
 */
class AmazonFulfillmentOrderCreatorTest extends TestCase
{
    /**
    ...
    public function testSetFulfillmentOrderId()
    {
        ...
        $this->assertTrue($this->object->setFulfillmentOrderId('123ABC'));
    ...
    public function testSetDisplayableOrderId()
    {
        ...
        $this->assertTrue($this->object->setDisplayableOrderId('ABC123'));
        $o = $this->object->getOptions();
    ...
    public function testSetDate()
    {
        ...
        $this->assertTrue($this->object->setDate('-1 min'));
        $o = $this->object->getOptions();
    ...
    public function testSetComment()
    {
        ...
        $this->assertTrue($this->object->setComment('A comment.'));
        $o = $this->object->getOptions();
    ...
    public function testSetShippingSpeed()
    {
        ...
        $this->assertTrue($this->object->setShippingSpeed('Standard'));
        $this->assertTrue($this->object->setShippingSpeed('Expedited'));
        $this->assertTrue($this->object->setShippingSpeed('Priority'));
        $o = $this->object->getOptions();
    ...
    public function testSetFulfillmentPolicy()
    {
        ...
        $this->assertTrue($this->object->setFulfillmentPolicy('FillOrKill'));
        $this->assertTrue($this->object->setFulfillmentPolicy('FillAll'));
        $this->assertTrue($this->object->setFulfillmentPolicy('FillAllAvailable'));
        $o = $this->object->getOptions();
    ...
    public function testSetFulfillmentMethod()
    {
        ...
        $this->assertTrue($this->object->setFulfillmentMethod('Consumer'));
        $this->assertTrue($this->object->setFulfillmentMethod('Removal'));
        $o = $this->object->getOptions();
    ...
    public function testSetAddress()
    {
        ...
        $this->assertTrue($this->object->setAddress($a1));
        ...
        $this->assertTrue($this->object->setAddress($a2)); //testing reset
    ...
    public function testSetEmails()
    {
        ...
        $this->assertTrue($this->object->setEmails($emails));
        ...
        $this->assertTrue($this->object->setEmails('just_one@testtwo.net')); //will cause reset
        $o2 = $this->object->getOptions();
    ...
    public function testSetItems()
    {
        ...
        $this->assertTrue($this->object->setItems($i));
        ...
        $this->assertTrue($this->object->setItems($i2)); //will cause reset
