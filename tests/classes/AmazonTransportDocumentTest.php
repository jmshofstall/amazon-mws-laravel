...
use Jmshofstall\AmazonMws\AmazonTransportDocument;
use PHPUnit\Framework\TestCase;

class AmazonTransportDocumentTest extends TestCase
{
    /**
    ...
    {
        resetLog();
        $this->object = new AmazonTransportDocument('testStore', null, true, null);
    }

    public function testSetUp()
    {
        $obj = new AmazonTransportDocument('testStore', '77', true, null);
    ...
    public function testSetPackageIds()
    {
        ...
        $ok2 = $this->object->setPackageIds(['string1', 'string2']);
        $this->assertNull($ok2);
    ...
    public function testFetchPackageLabels()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchPackageLabels.xml', $check[4]);
    ...
    public function testFetchPalletLabels()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchPalletLabels.xml', $check[4]);
    ...
    public function testBillOfLading()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchBillOfLading.xml', $check[3]);
