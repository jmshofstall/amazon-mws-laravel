...
class AmazonFinancialGroupListTest extends TestCase
{
    ...
    public function testFetchGroupList()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialGroups.xml', $check[3]);
    ...
    public function testFetchGroupListToken1()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialGroupsToken.xml', $check[2]);
    ...
    public function testFetchGroupListToken2()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialGroupsToken2.xml', $check[4]);
        $this->assertFalse($this->object->hasToken());
        $o = $this->object->getOptions();
