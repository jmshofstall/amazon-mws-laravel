...
class AmazonTransportTest extends TestCase
{
    ...
    {
        $obj = new AmazonTransport('testStore', '77', true, null);
    ...
    public function testSetPackages($type, $partnered)
    {
        ...
        $this->assertFalse($this->object->setPackages([]));
        $this->assertFalse($this->object->setPackages('banana'));
    ...
    public function testContact($type, $partnered)
    {
        ...
        $this->assertFalse($this->object->setContact([], '555-1234', 'test@email.com', '555-6789'));
        $this->assertFalse($this->object->setContact('Bob', [], 'test@email.com', '555-6789'));
        $this->assertFalse($this->object->setContact('Bob', '555-1234', [], '555-6789'));
        $this->assertFalse($this->object->setContact('Bob', '555-1234', 'test@email.com', []));
    ...
    public function testSendTransportContentsWithPartneredSp()
    {
        ...
        $this->assertEquals('Fetched Mock File: sendTransportContents.xml', $check[6]);
    }
    ...
    public function testSendTransportContentsWithNonPartneredSp()
    {
        ...
        $this->assertEquals('Fetched Mock File: sendTransportContents.xml', $check[7]);
    }
    ...
    public function testSendTransportContentsWithPartneredLtl()
    {
        ...
        $this->assertEquals('Fetched Mock File: sendTransportContents.xml', $check[8]);
    }
    ...
    public function testEstimateTransport()
    {
        ...
        $this->assertEquals('Fetched Mock File: estimateTransport.xml', $check[3]);
    }
    ...
    public function testConfirmTransport()
    {
        ...
        $this->assertEquals('Fetched Mock File: confirmTransport.xml', $check[3]);
    }
    ...
    public function testVoidTransport()
    {
        ...
        $this->assertEquals('Fetched Mock File: voidTransport.xml', $check[3]);
    }
    ...
    public function testFetchTransportSpPartnered()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchTransportContentSpPartnered.xml', $check[3]);
    ...
    public function testFetchTransportSpNonPartnered()
    {
        ...
        $this->assertEquals('Shipment ID must be set in order to get transport contents!', $check[2]);
        $this->assertEquals('Fetched Mock File: fetchTransportContentSpNonPartnered.xml', $check[3]);
    ...
    public function testFetchTransportLtlPartnered()
    {
        ...
        $this->assertEquals('Shipment ID must be set in order to get transport contents!', $check[2]);
        $this->assertEquals('Fetched Mock File: fetchTransportContentLtlPartnered.xml', $check[3]);
    ...
    public function testFetchTransportLtlNonPartnered()
    {
        ...
        $this->assertEquals('Shipment ID must be set in order to get transport contents!', $check[2]);
        $this->assertEquals('Fetched Mock File: fetchTransportContentLtlNonPartnered.xml', $check[3]);
