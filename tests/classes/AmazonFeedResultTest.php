...
use Jmshofstall\AmazonMws\AmazonFeedResult;
use PHPUnit\Framework\TestCase;

/**
 * Generated by PHPUnit_SkeletonGenerator 1.2.0 on 2012-12-12 at 13:17:14.
 */
class AmazonFeedResultTest extends TestCase
{
    /**
    ...
    {
        resetLog();
        $this->assertFalse($this->object->saveFeed('mocks/saveFeed.xml')); //nothing yet
        $o->saveFeed(__DIR__.'/../mocks/saveFeed.xml');
        $check = parseLog();
        $this->assertEquals('Successfully saved feed #77 at '.__DIR__.'/../mocks/saveFeed.xml', $check[0]);
    }
}
