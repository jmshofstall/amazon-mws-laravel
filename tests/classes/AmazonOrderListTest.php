 ...
 */
class AmazonOrderListTest extends TestCase
{
    /**
     * @var AmazonOrderList
     */
    ...
    public function testFetchItems()
    {
        ...
        $this->assertIsObject($get[0]);
        $this->assertIsObject($get[1]);
        $this->assertIsObject($get[2]);

        $getOne = $this->object->fetchItems('string', 0); //$token will be set to false
        $this->assertIsObject($getOne);
