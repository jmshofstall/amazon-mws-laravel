...
class AmazonFinancialEventListTest extends TestCase
{
    ...
    public function testFetchEventList()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialEvents.xml', $check[2]);
    ...
    public function testFetchEventListToken1()
    {
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialEventsToken.xml', $check[2]);
    ...
    {
        resetLog();
        $this->object->setMock(true, ['fetchFinancialEventsToken.xml', 'fetchFinancialEventsToken2.xml']);
        ...
        $this->assertEquals('Fetched Mock File: fetchFinancialEventsToken2.xml', $check[4]);
        $this->assertFalse($this->object->hasToken());
        $o = $this->object->getOptions();
