 ...
 */
class AmazonFulfillmentOrderListTest extends TestCase
{
    /**
    ...
    public function testGetOrder($o)
    {
        $order1 = $o->getOrder(0);
        $order2 = $o->getOrder(1);
        $this->assertIsArray($order1);
        $this->assertIsArray($order2);
    ...
    {
        resetLog();
        $this->object->setMock(true, ['fetchFulfillmentOrderList.xml', 'fetchFulfillmentOrder.xml', 'fetchFulfillmentOrder.xml']); //need files for orders
        $this->assertNull($this->object->fetchOrderList());
        ...
        $this->assertArrayHasKey(0, $r);
        $this->assertIsObject($r[0]);
        $this->assertIsObject($r[1]);
        $this->assertIsArray($r[0]->getOrder());
        $this->assertIsArray($r[1]->getOrder());
