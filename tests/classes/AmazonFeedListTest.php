 ...
 */
class AmazonFeedListTest extends TestCase
{
    /**
     * @var AmazonFeedList
     */
    ...
    public function testFetchFeedSubmissions()
    {
        ...
        $this->assertStringContainsString('Fetched Mock File:', $check[2]);
        $this->assertStringContainsString('fetchFeedSubmissions.xml', $check[2]);
